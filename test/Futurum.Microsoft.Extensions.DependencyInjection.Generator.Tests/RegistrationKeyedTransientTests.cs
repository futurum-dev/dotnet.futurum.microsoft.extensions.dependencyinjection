...
public class RegistrationKeyedTransientTests
{
    public class Default
    {
        ...
        [RegisterAsKeyedTransient("ServiceKey")]
    ...
    public class AsSelf
    {
        ...
        [RegisterAsTransient.AsKeyedSelf("ServiceKey")]
        public class Service : IService1, IService2
        {
        }
    ...
    public class DuplicateRegistrationStrategy
    {
        public class Try
        {
            ...
            [RegisterAsKeyedTransient("ServiceKey", DuplicateRegistrationStrategy = DependencyInjection.DuplicateRegistrationStrategy.Try)]
        ...
        public class Replace
        {
            ...
            [RegisterAsKeyedTransient("ServiceKey", DuplicateRegistrationStrategy = DependencyInjection.DuplicateRegistrationStrategy.Replace)]
            public class Service1 : IService
            {
            }
        ...
        public class Add
        {
            ...
            [RegisterAsKeyedTransient("ServiceKey", DuplicateRegistrationStrategy = DependencyInjection.DuplicateRegistrationStrategy.Add)]
            public class Service1 : IService
            {
            }
