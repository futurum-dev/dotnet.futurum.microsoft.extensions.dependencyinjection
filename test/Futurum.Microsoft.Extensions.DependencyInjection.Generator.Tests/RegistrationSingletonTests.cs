...
public class RegistrationSingletonTests
{
    ...
    public class DuplicateRegistrationStrategy
    {
        public class Try
        {
            ...
            [RegisterAsSingleton(DuplicateRegistrationStrategy = DependencyInjection.DuplicateRegistrationStrategy.Try)]
        ...
        public class Replace
        {
            ...
            [RegisterAsSingleton(DuplicateRegistrationStrategy = DependencyInjection.DuplicateRegistrationStrategy.Replace)]
            public class Service1 : IService
            {
            }
        ...
        public class Add
        {
            ...
            [RegisterAsSingleton(DuplicateRegistrationStrategy = DependencyInjection.DuplicateRegistrationStrategy.Add)]
            public class Service1 : IService
            {
            }
