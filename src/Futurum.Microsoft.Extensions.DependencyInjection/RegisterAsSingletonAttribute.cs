...
{
    /// <summary>
    /// Register as a singleton in dependency injection, as self only
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
    ...
    /// <summary>
    /// Register as a singleton in dependency injection, as specified type
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    ...
    /// <summary>
    /// Register as a singleton in dependency injection, as implemented interfaces
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
    ...
    /// <summary>
    /// Register as a singleton in dependency injection, as self and implemented interfaces
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
