...
/// <summary>
/// Register as a keyed singleton in dependency injection, as the only interface it implements
/// </summary>
[ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
[AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
public sealed class RegisterAsKeyedSingletonAttribute : RegisterAsKeyedAttribute
{
    public RegisterAsKeyedSingletonAttribute(string key) : base(key)
    {
    }
}

public static partial class RegisterAsSingleton
{
    /// <summary>
    /// Register as a keyed singleton in dependency injection, as self only
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
    ...
    /// <summary>
    /// Register as a keyed singleton in dependency injection, as specified type
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    ...
    /// <summary>
    /// Register as a keyed singleton in dependency injection, as implemented interfaces
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
    ...
    /// <summary>
    /// Register as a keyed singleton in dependency injection, as self and implemented interfaces
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
    ...
    /// <summary>
    /// Register as a keyed singleton in dependency injection, as open generic
    /// </summary>
    [ExcludeFromCodeCoverage(Justification = "No point in testing this. Only used in SourceGenerator.")]
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
